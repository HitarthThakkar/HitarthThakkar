...
| ------------------------------------------- | ------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [cite_start]**Mermaid-Studio** [cite: 18] | [cite_start]An AI-assisted diagramming tool that converts text prompts into Mermaid.js visualizations. [cite: 20]     | [cite_start]React, TypeScript, Vite, Tailwind CSS, Groq API [cite: 18]       | [cite_start]<a href="https://mermaid-studio.vercel.app/">**Live Demo**</a> [cite: 23]                                                                                                                                                                                          |
| [cite_start]**ChatPDF-AI** [cite: 23] | [cite_start]A Q&A system allowing users to have conversations with multiple PDF documents using a RAG approach. [cite: 25, 27] | [cite_start]Python, Streamlit, LangChain, Gemini API [cite: 23]                 | [cite_start]<a href="https://chat-pdf-ai.streamlit.app/">**Live Demo**</a> [cite: 29]                                                                                                                                                                                          |
